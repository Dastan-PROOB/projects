...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (asd) => TabsScreen(_favouriteMeals),
        CategoryMealsScreen.routeName: (asd) =>
            CategoryMealsScreen(_availableMeals),
        MealDetailScreen.routeNAme: (asd) => MealDetailScreen(_toggleFavourite,_isMealFavourite),
        FiltersScreen.routeName: (asd) => FiltersScreen(_filters,_setFilters),
      },
    );
  }
}
